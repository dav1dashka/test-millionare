...
const MoneyItem = ({ money, type }: MoneyItemProps) => {
    const classItem = type ? `money-item ${type}` : "money-item";

    return (
        <li className={classItem}>
            <svg className="money-item__svg" width="580" height="80" viewBox="0 0 375 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="money-item__text">
                <p>${money}</p>
            </div>
        </li>
    );
